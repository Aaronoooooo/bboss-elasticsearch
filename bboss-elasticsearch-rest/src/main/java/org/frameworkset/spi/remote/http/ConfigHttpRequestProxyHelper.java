...
public class ConfigHttpRequestProxyHelper {
    ...
    public static ConfigHttpRequestProxy getHttpConfigClientProxy(String poolName,BaseTemplateContainerImpl templateContainer){
    ...
    public static ConfigHttpRequestProxy getHttpConfigClientProxy(BaseTemplateContainerImpl templateContainer){
        String namespace = templateContainer.getNamespace();
